...
This repository accompanies the German-language master's thesis „Wirtschaftliche und technische Analyse von BI- und Analytics-Plattformarchitekturen: Cloud Data Warehouses versus lokale Alternativen am Beispiel von Snowflake und DuckDB. The README is written in English to serve as a portfolio project.
...
> The `data/` directory is created by the generator script and excluded via `.gitignore`.
> Benchmark result CSVs are generated by running the benchmark scripts.
